...
public class JwtAuthorizationGenerator {
    ...
    public Option<String> generate(String httpMethodStr, String url, Map<String, List<String>> parameters,
        ...
        URI uriWithoutProductContext = new URI(uri.getScheme(), uri.getUserInfo(), uri.getHost(), uri.getPort(),
    ...
    public Option<String> generate(HttpMethod httpMethod, URI url, Map<String, List<String>> parameters, AcHost acHost,
        ...
        return Option
                .some("JWT " + this.encodeJwt(httpMethod, url, paramsAsArrays, (String) userId.getOrNull(), acHost));
    }
    ...
    private String encodeJwt(HttpMethod httpMethod, URI targetPath, Map<String, String[]> params, String userKeyValue,
        ...
        JwtJsonBuilder jsonBuilder = (new JsonSmartJwtJsonBuilder()).issuedAt(TimeUtil.currentTimeSeconds())
                .expirationTime(TimeUtil.currentTimePlusNSeconds((long) this.jwtExpiryWindowSeconds))
        ...
        try {
            ...
            CanonicalHttpUriRequest e = new CanonicalHttpUriRequest(httpMethod.toString(), targetPath.getPath(), "",
                    (Map) completeParams);
            ...
            while (!cursor.atEnd()) {
                ...
                if (!StringUtils.isEmpty(nameValuePair.getName())) {
                    ...
                    String[] newValues = null == oldValues ? new String[1]
                            : (String[]) Arrays.copyOf(oldValues, oldValues.length + 1);
