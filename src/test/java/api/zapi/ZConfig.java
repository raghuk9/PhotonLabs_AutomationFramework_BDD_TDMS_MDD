...
public class ZConfig extends PropertiesConfiguration {
    ...
    final List<String> reqdConfigKeys = ImmutableList.<String>builder().add("userName").add("jiraHostKey")
            .add("jiraBaseURL").add("sharedSecret").add("zephyrBaseURL").add("accessKey").add("secretKey").add("appKey")
            .build();
